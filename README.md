...
Метод input_text(self)
Вызывает диалоговое окно для ввода текста, который нужно разместить на холсте.

Метод motion(self, event)
Размещает текст в указанной точке на холсте

Метод choice_fon(self)
Пользователь может самостоятельно выбрать общий цвет холста.

![Снимок экрана (16)](https://github.com/user-attachments/assets/377035af-7aac-4e45-abb7-06d21836788a)
